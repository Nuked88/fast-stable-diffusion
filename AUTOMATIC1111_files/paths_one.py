...
script_path = '/content/onedrive/MyDrive/sd/stable-diffusion-webui'
models_path = os.path.join(script_path, "models")
sys.path.insert(0, script_path)

# search for directory of stable diffusion in following places
sd_path = None
possible_sd_paths = [os.path.join(script_path, '/content/onedrive/MyDrive/sd/stable-diffusion'), '.', os.path.dirname(script_path)]
